...
namespace VL.Stride.Rendering.Lights
{
    ...
    /// </summary>
    public class ForwardLightingRenderFeature : global::Stride.Rendering.Lights.ForwardLightingRenderFeature
    {
        /// <summary>
        ...
        public class RenderViewLightData : global::Stride.Rendering.Lights.ForwardLightingRenderFeature.RenderViewLightData
        {
            /// <summary>
            /// Gets the lights without shadow per light type.
            /// </summary>
            /// <value>The lights.</value>
            public new readonly Dictionary<Type, RenderLightCollectionGroup> ActiveLightGroups;

            internal readonly List<ActiveLightGroupRenderer> ActiveRenderers;

            public new readonly List<RenderLight> VisibleLights;
            public new readonly List<RenderLight> VisibleLightsWithShadows;

            public new readonly Dictionary<RenderLight, LightShadowMapTexture> RenderLightsWithShadows;
        ...
        public override void Collect()
        {
            ...
            // Collect shadow maps
            ShadowMapRenderer?.Collect(Context, renderViewDatas.Select(x => KeyValuePair.Create(x.Key, (global::Stride.Rendering.Lights.ForwardLightingRenderFeature.RenderViewLightData)x.Value)).ToDictionary());
        }
        ...
        private RenderLightCollectionGroup GetLightGroup(RenderViewLightData renderViewData, RenderLight light)
        {
            ...
            {
                lightGroup = RenderLightCollectionGroupExt.RenderLightCollectionGroup(type);
        ...
        public class LightShaderPermutationEntry : global::Stride.Rendering.Lights.ForwardLightingRenderFeature.LightShaderPermutationEntry
        {
            ...
            public new FastListStruct<LightShaderGroup> DirectLightGroups;

            public new readonly ShaderSourceCollection DirectLightShaders;

            public new FastListStruct<LightShaderGroup> EnvironmentLights;

            public new readonly ShaderSourceCollection EnvironmentLightShaders;

            /// <summary>
            /// Light groups that have <see cref="LightShaderGroup.HasEffectPermutations"/>.
            /// </summary>
            public new FastListStruct<LightShaderGroup> PermutationLightGroups;
        }
    ...
    static class RenderLightCollectionGroupExt
    {
        static MethodInfo prepareLight = typeof(RenderLightCollectionGroup).GetMethod("PrepareLight", BindingFlags.NonPublic | BindingFlags.Instance);
        static object[] prepareLightarg = new object[1];

        static MethodInfo addLight = typeof(RenderLightCollectionGroup).GetMethod("AddLight", BindingFlags.NonPublic | BindingFlags.Instance);
        static object[] addLightarg = new object[1];


        static MethodInfo clear = typeof(RenderLightCollectionGroup).GetMethod("Clear", BindingFlags.NonPublic | BindingFlags.Instance);
        static MethodInfo allocateCollectionsPerGroupOfCullingMask = typeof(RenderLightCollectionGroup).GetMethod("AllocateCollectionsPerGroupOfCullingMask", BindingFlags.NonPublic | BindingFlags.Instance);

        public static void PrepareLight(this RenderLightCollectionGroup renderLightCollectionGroup, RenderLight renderLight)
        {
            if (renderLightCollectionGroup != null)
            {
                prepareLightarg[0] = renderLight;
                prepareLight.Invoke(renderLightCollectionGroup, prepareLightarg);
            }
        }
        public static void AddLight(this RenderLightCollectionGroup renderLightCollectionGroup, RenderLight renderLight)
        {
            if (renderLightCollectionGroup != null)
            {
                addLightarg[0] = renderLight;
                addLight.Invoke(renderLightCollectionGroup, null);
            }
        }

        public static void Clear(this RenderLightCollectionGroup renderLightCollectionGroup)
        {
            if (renderLightCollectionGroup != null)
            {
                clear.Invoke(renderLightCollectionGroup, null);
            }
        }

        public static void AllocateCollectionsPerGroupOfCullingMask(this RenderLightCollectionGroup renderLightCollectionGroup)
        {
            if (renderLightCollectionGroup != null)
            {
                allocateCollectionsPerGroupOfCullingMask.Invoke(renderLightCollectionGroup, null);
            }
        }

        public static RenderLightCollectionGroup RenderLightCollectionGroup(Type lightType)
        {
                var type = typeof(RenderLightCollectionGroup);
                var instance = type.Assembly.CreateInstance(
                    type.FullName, false,
                    BindingFlags.Instance | BindingFlags.NonPublic,
                    null, new object[] { lightType }, null, null);
                return (RenderLightCollectionGroup)instance;
